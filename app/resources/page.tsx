  ...
  return (
    <div className="space-y-12">
      <section className="space-y-4">
        <h1 className="font-serif text-4xl text-peacock-900 sm:text-5xl">Study resources</h1>
      ...
      <section className="grid gap-6 md:grid-cols-3">
        {resourceCollections.map((collection) => (
          ...
          >
            <div>
              <h2 className="font-serif text-2xl text-peacock-900">{collection.title}</h2>
      ...
      <section className="rounded-3xl border border-pearl-200 bg-gradient-to-br from-peacock-900 via-peacock-700 to-peacock-600 p-8 text-sand-25 shadow-soft">
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            <h2 className="font-serif text-3xl">Share your intentions</h2>
